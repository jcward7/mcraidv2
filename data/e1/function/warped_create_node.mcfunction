...
execute if entity @e[tag=dummy,scores={randomValue=1,warpedNodeAnimation=2}] run summon arrow 130 85.35 72 {NoGravity:1b,Motion:[0.0,0.05,0.0],Tags:["node_animator"]}
...
#node position 2
execute if entity @e[tag=dummy,scores={randomValue=2,warpedNodeAnimation=2}] run summon arrow 117 89.35 108 {NoGravity:1b,Motion:[0.0,0.05,0.0],Tags:["node_animator"]}
...
#node position 3
execute if entity @e[tag=dummy,scores={randomValue=3,warpedNodeAnimation=2}] run summon arrow 136 89.35 97 {NoGravity:1b,Motion:[0.0,0.05,0.0],Tags:["node_animator"]}
...
#node position 4
execute if entity @e[tag=dummy,scores={randomValue=4,warpedNodeAnimation=2}] run summon arrow 145 89.35 111 {NoGravity:1b,Motion:[0.0,0.05,0.0],Tags:["node_animator"]}
...
#node position 5
execute if entity @e[tag=dummy,scores={randomValue=5,warpedNodeAnimation=2}] run summon arrow 153 94.35 95 {NoGravity:1b,Motion:[0.0,0.05,0.0],Tags:["node_animator"]}
...
#node position 6
execute if entity @e[tag=dummy,scores={randomValue=6,warpedNodeAnimation=2}] run summon arrow 151 89.35 87 {NoGravity:1b,Motion:[0.0,0.05,0.0],Tags:["node_animator"]}
