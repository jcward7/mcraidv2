...
#summon armor_stand ~ ~ ~ {NoGravity:1b,ShowArms:1b,Invisible:0b,Tags:["shield_orbit1"],Pose:{RightArm:[76f,84f,0f]},HandItems:[{id:"minecraft:shield",count:1},{}]}
#summon armor_stand ~ ~ ~ {NoGravity:1b,ShowArms:1b,Invisible:0b,Tags:["shield_orbit2"],Pose:{RightArm:[76f,84f,0f]},HandItems:[{id:"minecraft:shield",count:1},{}]}
#summon armor_stand ~ ~ ~ {NoGravity:1b,ShowArms:1b,Invisible:1b,Tags:["shield_orbit3"],Pose:{RightArm:[76f,84f,0f]},HandItems:[{id:"minecraft:shield",count:1},{}]}
