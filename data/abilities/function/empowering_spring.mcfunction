...
execute as @e[scores={ability2=2}] run kill @e[tag=spring_center]
execute as @e[scores={ability2=2}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:0b,PersistenceRequired:1b,NoGravity:1b,Tags:["spring_center"],DisabledSlots:47}
execute as @e[scores={ability2=2}] at @s run summon block_display ~-3.75 ~ ~-3.75 {Glowing:1b,shadow_radius:0f,shadow_strength:0f,start_interpolation:-1,interpolation_duration:100,Tags:["spring"],glow_color_override:1025636,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[7.5f,0.075f,7.5f]},block_state:{Name:"minecraft:lime_stained_glass"}}
